...
Navigating to the [templates folder](https://github.com/martinesmann/couchbase-azure/tree/master/src/templates), reveals eleven separate files:
...
##Summery
In this blog post you learned about Azure Resource Manager Templates and there usage. We also briefly touched on the specific details for the Couchbase ARM template and the various ways you can interact with Azure and deploy ARM templates.
